<?php
	  ...
	  $_SESSION["ses_id"] = "1";
	  $_SESSION["ses_nama"] = "Sabar Budiman";
	...
	$sql = $koneksi->query("SELECT * from tiket");
	while ($data= $sql->fetch_assoc()) {
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text">BUS ALS</span>
			</a>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							<a href="?page=data-penumpang" class="nav-link">
						...
						<li class="nav-item">
							<a href="?page=data-tiket" class="nav-link">
								<i class="nav-icon far fa fa-users"></i>
								<p>
									Data Tiket
								</p>
						...
						<li class="nav-item">
							<a href="?page=data-bus" class="nav-link">
								<i class="nav-icon far fa fa-users"></i>
								<p>
									BUS
								</p>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				case 'data-penumpang':
					include "admin/penumpang/data_penumpang.php";
					break;
				case 'add-penumpang':
					include "admin/penumpang/add_penumpang.php";
					break;
				case 'edit-penumpang':
					include "admin/penumpang/edit_penumpang.php";
					break;
				case 'del-penumpang':
					include "admin/penumpang/del_penumpang.php";
					break;
				case 'view-penumpang':
					include "admin/penumpang/view_penumpang.php";
					break;

				case 'data-produk':
					include "admin/produk/data_tiket.php";
					break;
				case 'add-produk':
					include "admin/produk/add_tiket.php";
					break;
				case 'edit-produk':
					include "admin/produk/edit_tiket.php";
					break;
				case 'del-produk':
					include "admin/produk/del_tiket.php";
					break;
				case 'view-produk':
					include "admin/produk/view_tiket.php";
					break;
